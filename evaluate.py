...
Loads a trained checkpoint, rebuilds the same test split, and reports
full evaluation metrics + confusion matrix + inference timing.
"""
...
def main():
    ...
    print(f"Average per-sample inference time: {avg_ms:.3f} ms  (device={device})")
